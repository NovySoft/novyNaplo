...
Nem tudom, hogy önök szándékosan keserítik/nehezítik meg az alternatív kliens fejlesztők életét, de a módszerek melyeket bevetnek, még egy kezdő 15 éves programozót (pl.: engem) sem képesek visszatartani a folytatástól, viszont egy levél, melyben a „NEM” szó található viszont már képes lenne. Tény, hogy vannak dolgok melyeket nem ideális módon önöktől kérve szerzünk meg, mint pl. a lentebb található encoder kulcs, api kulcsok vagy esetleg a client_id, de, hogyan szerezhetnénk meg ezeket a „titkokat” „nem sértő módon”, ha nem válaszolnak a leveleinkre?
